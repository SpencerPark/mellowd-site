...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var CodeMirror = __webpack_require__(386);
	__webpack_require__(387);
	__webpack_require__(388);
	var Wiki;
	(function (Wiki) {
	    function mountCodeComponent(element, displayCode, realCode) {
	        var pre = document.createElement('pre');
	        pre.className = "cm-s-ambiance";
	        pre.setAttribute("style", "cursor: pointer");
	        element.appendChild(pre);
	        CodeMirror.runMode(displayCode, 'mellowd', pre);
	    }
	    Wiki.mountCodeComponent = mountCodeComponent;
	    Wiki.TRY_CODE_CLASS_NAME = "try-mellowd";
	    function mountAll() {
	        var codeBlocks = document.getElementsByClassName(Wiki.TRY_CODE_CLASS_NAME);
	        for (var i = 0; i < codeBlocks.length; i++) {
	            var codeBlock = codeBlocks[i];
	            var displayCodeElement = codeBlock.children[0];
	            var realCodeElement = codeBlock.children[1];
	            var displayCode = displayCodeElement.innerText;
	            var realCode = realCodeElement.innerText;
	    ...
	    Wiki.mountAll = mountAll;
	})(Wiki = exports.Wiki || (exports.Wiki = {}));
	Wiki.mountAll();
